      ...
      if (urlParams.length > 0) {
        schema2.request = {
          params: external_exports.object(
            urlParams.reduce(
              (obj, item2) => Object.assign(obj, {
                [item2]: external_exports.string()
              }),
              {}
            )
          )
...
// src/endpoints/items/base.ts
var item = external_exports.object({
  id: external_exports.number().int().optional(),
  name: external_exports.string(),
  product_code: external_exports.string(),
  color: external_exports.string().optional(),
  price: external_exports.number(),
  img_urls: external_exports.string().optional(),
  stock: external_exports.number().default(0),
  cp: external_exports.number().optional(),
  sp: external_exports.number().optional(),
  created_at: external_exports.string().datetime().optional(),
  updated_at: external_exports.string().datetime().optional(),
  modified_by: external_exports.string().optional()
});
var ItemModel = {
  tableName: "items",
  primaryKeys: ["id"],
...
var ItemCreate = class extends D1CreateEndpoint {
  static {
    __name(this, "ItemCreate");
  }
  _meta = {
    model: ItemModel,
...
// src/endpoints/items/itemList.ts
var ItemList = class extends D1ListEndpoint {
  static {
    __name(this, "ItemList");
  }
  _meta = {
    model: ItemModel
  };
...
// src/endpoints/items/itemRead.ts
var ItemRead = class extends D1ReadEndpoint {
  static {
    __name(this, "ItemRead");
  }
  _meta = {
    model: ItemModel
  };
...
// src/endpoints/items/itemUpdate.ts
var ItemUpdate = class extends D1UpdateEndpoint {
  static {
    __name(this, "ItemUpdate");
  }
  _meta = {
    model: ItemModel,
    fields: ItemModel.schema.pick({
...
// src/endpoints/items/itemDelete.ts
var ItemDelete = class extends D1DeleteEndpoint {
  static {
    __name(this, "ItemDelete");
  }
  _meta = {
    model: ItemModel
  };
...
// src/endpoints/items/router.ts
var itemsRouter = fromHono(new Hono2());
